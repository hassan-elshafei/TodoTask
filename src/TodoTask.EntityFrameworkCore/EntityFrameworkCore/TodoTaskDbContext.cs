...
public class TodoTaskDbContext :
	AbpDbContext<TodoTaskDbContext>,
	IIdentityDbContext,
	ITenantManagementDbContext
{
	...
	protected override void OnModelCreating(ModelBuilder builder)
	{
		...
		{
			b.ToTable("Todos");
			b.ConfigureByConvention(); // Auto fields config
		...
		//{
		//    b.ToTable(TodoTaskConsts.DbTablePrefix + "YourEntities", TodoTaskConsts.DbSchema);
